...
double VectorGridFunctionDotProductCoefficient::Eval(
...
void VectorGridFunctionDotProductAux::Init(
  ...
  coefficients.scalars.Register(
      _coef_name,
      new VectorGridFunctionDotProductCoefficient(*_scaling_coef, _u_gf_re,
                                                  _v_gf_re, _u_gf_im, _v_gf_im),
      true);
