...
//   sigmaCoef =
//   domain_properties.scalar_property_map["electrical_conductivity"]; muCoef =
//   domain_properties.scalar_property_map["magnetic_permeability"]; muInvCoef =
//   new mfem::TransformedCoefficient(&oneCoef, muCoef, fracFunc); dtMuInvCoef =
//   new mfem::TransformedCoefficient(&dtCoef, muInvCoef, prodFunc);
...
//   Phi_gf = 0.0;
//   *b0 = 0.0;
//   _bc_map.applyEssentialBCs("electric_potential", poisson_ess_tdof_list,
//   Phi_gf,
//                             pmesh_);
...
//   mfem::common::VisualizeField(*socks_["electric_field"], vishost, visport,
//   e_,
//                                "Electric Field (E)", Wx, Wy, Ww, Wh);
//   Wx += offx;

//   mfem::common::VisualizeField(*socks_["magnetic_flux_density"], vishost,
//                                visport, b_, "Magnetic Flux Density (B)", Wx,
//                                Wy, Ww, Wh);
//   Wx += offx;

//   mfem::common::VisualizeField(*socks_["electric_potential"], vishost,
//   visport,
