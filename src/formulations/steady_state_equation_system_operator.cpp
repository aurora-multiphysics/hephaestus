#include "steady_state_equation_system_operator.hpp"
...
void SteadyStateEquationSystemOperator::Init(mfem::Vector &X) {
...
void SteadyStateEquationSystemOperator::Solve(mfem::Vector &X) {}
