...
template <typename T>
std::vector<T *>
populateVectorFromNamedFieldsMap(mfem::NamedFieldsMap<T> nfmap, std::vector<std::string> keys)
{
  std::vector<T *> result;
  for (auto & key : keys)
  {
...
protected:
  ...
  mfem::NamedFieldsMap<mfem::Array<hephaestus::Kernel<mfem::ParBilinearForm> *>> blf_kernels_map;
  mfem::NamedFieldsMap<mfem::Array<hephaestus::Kernel<mfem::ParLinearForm> *>> lf_kernels_map;
  mfem::NamedFieldsMap<mfem::Array<hephaestus::Kernel<mfem::ParNonlinearForm> *>> nlf_kernels_map;
  mfem::NamedFieldsMap<
      mfem::NamedFieldsMap<mfem::Array<hephaestus::Kernel<mfem::ParMixedBilinearForm> *>>>
