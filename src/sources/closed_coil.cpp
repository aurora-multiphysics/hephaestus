...
ClosedCoilSolver::solveCoil()
{
  ...
  mfem::ParDiscreteLinearOperator grad(H1FESpace_coil_, Jaux_coil_->ParFESpace());
  ...
  *J_parent_ = 0.0;
  ...
  m1.AddDomainIntegrator(new mfem::VectorFEMassIntegrator(new mfem::ConstantCoefficient(1.0)),
                         coil_markers_);
  m1.Assemble();
