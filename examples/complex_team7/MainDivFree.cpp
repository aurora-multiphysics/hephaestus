...
//       "electrical_conductivity", new mfem::ConstantCoefficient(3.526e7),
//       true);
...
//                                 new mfem::ConstantCoefficient(8.854e-12),
//                                 true);
...
//                    new hephaestus::DivFreeSource(div_free_source_params),
//                    true);
//   return sources;
// }
...
//           "dielectric_permittivity", "frequency",
//           "magnetic_vector_potential", "magnetic_vector_potential_real",
...
//   problem_builder->AddGridFunction("magnetic_vector_potential_real",
//   "HCurl");
//   problem_builder->AddGridFunction("magnetic_vector_potential_imag",
//   "HCurl");
